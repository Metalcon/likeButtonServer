...
import de.metalcon.like.storage.PersistentUUIDArrayMapLevelDB;
...
class Commons {
	...
	private PersistentUUIDArrayMapLevelDB persistentCommonsMap = null;
	...
	public Commons(final Node node, final Vote likeType) {
		this.node = node;
		persistentCommonsMap = new PersistentUUIDArrayMapLevelDB(node.getUUID());
